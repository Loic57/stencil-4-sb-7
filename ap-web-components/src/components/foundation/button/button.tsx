...
export class APButton {
  ...
  render() {
    ...
    >
      { this.iconPosition === 'left' && this.icon && this.icon !== '' ? <ap-icon icon={this.icon} size={this.size === 'lg' || this.size === 'default' ? '16' : '12' } /> : '' }
      { !this.iconOnly && this.content }
      { this.iconOnly && <ap-icon icon={this.icon} size={this.size === 'lg' || this.size === 'default' ? '16' : '12' } /> }
      { this.iconPosition === 'right' && this.icon && this.icon !== '' ? <ap-icon icon={this.icon} size={this.size === 'lg' || this.size === 'default' ? '16' : '12' } /> : '' }
    </Host>;
  }
}
